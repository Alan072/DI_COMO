...
@section('contenido')
    ...
    <div class="w-full max-w-xl p-4 bg-white mx-auto" style="max-width: 80%;">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="my-6">
                <h1 class="text-blue-500">Productos</h1>
            </div>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="nombre_producto" name="nombre_producto"
                            ...
                            placeholder="Balon de futbol" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="precio" name="precio" min="0.00" max="999999.99" step="0.01"
