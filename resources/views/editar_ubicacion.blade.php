...
@section('contenido')
    ...
    <div class="bg-white rounded-lg shadow p-6" style="width: 50%; margin-left: 20px;">
        <div style="position: relative; z-index: 1;">
            <div style="margin-left: 20px; position: absolute; top: 0; left: 0;">
                ...
                <div class="bg-white rounded-lg shadow p-6" style="width: 50%; margin-left: 20px; margin-top: 20px;">
                    <form method="post" action="{{ route('update_ubicacion', $ubicacion->id_ubicacion) }}">
                        @csrf
                        {!! method_field('PUT') !!} @csrf
                        <label>Pasillo</label>
                        <input type="text" name="pasillo" value="{{ $ubicacion->pasillo }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            style="width: 300%;" placeholder="sector 1" required>
                        <label>Rack</label><br>
                        <input type="text" name="rack" value="{{ $ubicacion->racks }}"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            style="width: 300%;" placeholder="1" required>
                        <br>
                </div>
                <div>
                    <button type="submit"
