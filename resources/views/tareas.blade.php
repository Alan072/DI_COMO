...
@section('contenido')
    ...
    <div class="w-full max-w-xl p-4 bg-white mx-auto" style="max-width: 80%;">
        <div class="my-6">
            <h1 class="text-blue-500">Tareas</h1>
        </div>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <textarea name="descripcion" style="resize: none;"
                            ...
                            placeholder="XXXXXXXX" required></textarea>
                    </div>
                    <div>
                        ...
                        <select id="idsalida" name="idsalida"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required>
                    ...
                    <div>
                        ...
                        <select id="idusuario" name="idusuario"
                            ...
                            // Realizar la consulta a la base de datos
                            $query = 'SELECT * FROM tipo_usuario where rol_desempena = 2';
                    ...
                    <div>
                        ...
                        <select id="identrada" name="identrada"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            required>
