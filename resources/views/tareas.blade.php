    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        <form method="post" action="{{ route('CTarea_insertada') }}">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Salida</label>
                    <input type="number" name="idsalida" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="1" required>
                </div>
                <div>
                ...
                <div>
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ID Entrada</label>
                    <input type="number" name="identrada" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="1" required>
                </div>
            </div>
            <div class="flex">
                <div>
