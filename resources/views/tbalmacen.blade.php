        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="flex items-center px-6 py-4 space-x-3">
                    <a href="{{ route('editar_almacen', $item->id_almacen) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar</a>
                    <form id="eliminar-producto" action="{{ route('eliminar_almacen', ['id_almacen' => $item->id_almacen]) }}" method="POST" class="inline-block">
                        @csrf
                        @method('DELETE')
